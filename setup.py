...
_deps = [
    ...
    "liger_kernel==0.5.3",
    "lighteval @ git+https://githubfast.com/huggingface/lighteval.git@ed084813e0bd12d82a06d9f913291fdbee774905",
    ...
    "torch==2.5.1",
    "transformers==4.49.0",
    "trl @ git+https://githubfast.com/huggingface/trl.git@69ad852e5654a77f1695eb4c608906fe0c7e8624",
    "vllm==0.7.2",
    "wandb>=0.19.1",
]
